...
use bevy::app::App;
use bevy::prelude::{in_state, Changed, Commands, Component, IntoScheduleConfigs, Justify, OnEnter, Query, Reflect, Text2d, TextLayout, Transform, Update, Vec3, With};

pub(super) fn plugin(app: &mut App) {
    app
        .add_systems(OnEnter(GameState::RUNNING), spawn_health_display_system)
        .add_systems(Update, update_health_display_system.run_if(in_state(GameState::RUNNING)));
}
