...
use crate::world::map::map::{Interpolator, Map, Path, PathStrategy, Strategy, VertexGenerator};
...
mod tests {
    ...
    use crate::world::map::map::Interpolator;
    use crate::world::map::simple_map::SimpleInterpolator;
